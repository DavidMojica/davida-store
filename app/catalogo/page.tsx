...
const ropa_2 = new Product(1,'Camiseta de mariposa', 'Camiseta con cuello redondo y estampado de marposas camiseta informal de manga corta para todas las ocasiones',
  0, 'ropa', ['ropa_2_1.jpeg', 'ropa_2_2.jpeg', 'ropa_2_3.jpeg'], false, 'MX', 'Azul', 'Sentirme bien con lo que llevo puesto mejora mi confianza y actitud.');
const ropa_3 = new Product(2, 'Camisa de cuadros', 'Camiseta de verano estampado con bloques multicoleres top vintage de manga corta y cuello redondo.',
  0, 'ropa', ['ropa_3_1.jpeg', 'ropa_3_2.jpeg', 'ropa_3_3.jpeg'], false, 'MX', 'Varios', 'La experiencia de comprar lo nuevo me generan placer y emociones positivas.');
const ropa_4 = new Product (5, 'Blusa estampada floral', 'Blusa con cuello de muesca estampado flora casual con botones decoracion de manga larga',
  0, 'ropa', ['ropa_4_1.jpeg','ropa_4_2.jpeg','ropa_4_3.jpeg'], false, 'MX', 'Azul', 'La satisfacción de cuidarse a uno mismo te recompensa.');
...
const ropa_7 = new Product(8, 'Blusa con cremallera', 'Blusa con cremallera de un cuarto y bloques de color blusa camiseta informal de manga larga',
  0, 'ropa', ['ropa_7_1.jpeg','ropa_7_2.jpeg','ropa_7_3.jpeg'], false, 'MX', 'Rosa', 'Conexión y colores que evocan recuerdos significativos.');
...
const ropa_15 = new Product(16, 'Camiseta estampada', 'Camiseta blusa cuello etnico estampado selva manga larga',
  0, 'ropa', ['ropa_15_1.jpeg','ropa_15_2.jpeg','ropa_15_3.jpeg'], false, 'MX', 'Azul', 'Nueva adquisición que resalta mis mejores atributos.');
// Accesorios
...
const accesorio_4 = new Product(4, 'Reloj Madera', 'Reloj de madera con esfera de flores de moda cuarzo digital vintage eleccion para regalos y detalles',
      0, 'accesorios', ['accesorio_2_1.jpeg'], false, '-','Varios','El estilo y el estado de ánimo es la autoexpresión de quien soy y como me siento.'); //45000
//Bolsos
...
//-----------Lista de productos-------------//
const products:Product[] = [accesorio_5, accesorio_6, ropa_1,ropa_2, ropa_3, ropa_4, ropa_5, ropa_6,ropa_7,ropa_8,ropa_9,ropa_10,ropa_11,ropa_12,ropa_13,ropa_14,ropa_15, accesorio_1, accesorio_2, accesorio_3, accesorio_4, tecnologia_1, otros_1]; 
